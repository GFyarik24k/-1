...
int main() {
	...
	while (b != 0) {
		...
		case 1: {
			...
			cout << " Нажмите 0 для завершения ДЗ_1 " << endl;
		...
		case 2: {
			...
			case 5: {
				...
				break; } //задание 5 завершено

			} //выбор задания из ДЗ_2 завершён
			break; }    // ДЗ_2 завершено 
		case 3: {
			...
			//break; }
				  //задание 2 завершено
			} //выбор задания из ДЗ_3 завершён
			break; } //ДЗ_3 завершено
		} //выбор дз завершён 
	}
	cout << "конец";
	return (0);
